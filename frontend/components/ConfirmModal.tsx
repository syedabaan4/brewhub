...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      ...
      {/* Modal */}
      <div
        className="relative bg-[#F7F7F5] w-full max-w-[95vw] sm:max-w-sm lg:max-w-md z-10"
        style={{
          borderRadius: "0px",
      ...
      >
        {/* Header */}
        <div
          className="bg-[#E97F8A] px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6"
          style={{ borderBottom: "2px solid rgba(18,18,18,0.1)" }}
        >
          <div className="inline-block mb-2 sm:mb-3">
            <div className="bg-[#121212] px-3 sm:px-4 py-1 sm:py-1.5">
              <span className="text-[#F7F7F5] font-bold text-[9px] sm:text-[10px] tracking-[0.15em] uppercase">
                Confirmation
              </span>
            </div>
          </div>
          <h2
            className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#121212] leading-tight"
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6">
          <p
            className="text-sm sm:text-base text-[#121212] opacity-70 leading-relaxed"
